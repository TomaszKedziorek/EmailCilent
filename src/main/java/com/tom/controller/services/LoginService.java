...
public class LoginService extends Service<EmailLoginResult> {
  ...
  //Enum type with states to return
  public EmailLoginResult login() {
    //The class Authenticator represents an object that knows how to obtain authentication for a network connection.
    //getPasswordAuthentication should override the default implementation, which returns null.
    ...
    //So if authentication is success it return object with email & password or null otherwise
